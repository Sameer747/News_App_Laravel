                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="article__entry">
                                            <div class="article__image">
                                                <a href="#">
                                                    <img src="images/newsimage6.png" alt=""
                                                        class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="article__content">
                            ...
                            <div class="col-md-12">
                                <div class="border-top-1 bg__footer-bottom-section">
                                    <p class="text-white text-center">
                                        {{ __('Copyright') }} &copy; <?php echo date(__('Y')); ?>
                                        {{ __('Top News Developed by ') }} <a style="color:currentColor"
                                            href="https://pk.linkedin.com/in/sameer-mohsin-990618178/en">{{ __('Sameer Mohsin') }}</a>
                                    </p>
